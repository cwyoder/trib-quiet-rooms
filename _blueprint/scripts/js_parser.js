  ...
  var handler = new htmlparser.DomHandler(function(error, dom) {
    var tagHandlers = {
      ...
      a: function (aTag) {
        ...
        var str = `<a target="_blank" rel="noopener" href="${href}">`;
    ...
    // ##########################################
    // I omitted this decoding step because we'd like to preserve the HTML entities
    // to get smart quotes and the like. -- Ryan (Apr 2018)
    // ##########################################
